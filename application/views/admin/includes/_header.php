...
<head>
  ...
  <link rel="icon" href="<?= base_url($this->general_settings['favicon']); ?>" sizes="32x32" />
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-sm-inline-block">
        <a style="font-size: 18px; font-weight: 600;    right: 0; color: #05498c;" href="<?= base_url('admin/auth/logout') ?>" class="nav-link"><?= trans('logout') ?></a>
      </li>
    </ul>
