      ...
      <div class="card card-default">
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open( base_url('admin/download_report/report_pdf_download')); ?>
...
<script src="<?= base_url() ?>assets/plugins/datatables/dataTables.bootstrap4.js"></script><script src="https://gyrocode.github.io/jquery-datatables-checkboxes/1.2.12/js/dataTables.checkboxes.min.js"></script>
  ...
  <script>
    ...
    $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/download_report/year_by_athlete",
        dataType: 'json',
...
$(document).on('change', '#select_year', function() {
    ...
    $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/download_report/select_year",
        dataType: 'json',
