...
$html .= '<section style="page-break-after:always">
    ...
    <p>*PLAYERS SCORED ON EACH ATTRIBUTE FROM 1 TO 5, WITH 1 BEING THE LOWEST AND 5 BEING THE HIGHEST</p>
    </div>
</section>';
...
$html .= '<section style="page-break-after:always">
    ...
    <table style="width: 100%;">
        <tbody>
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">KEY PERFORMANCE INDICATOR</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$default_q_name.'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">Cycle 2</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">Q3</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">Q4</td>' : '';
            $html .='</tr>

            <tr>
                <td style="padding: 20px 5px;"></td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
            $html .='</tr>

            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">READING OF THE GAME</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["ta_reading_game"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["ta_reading_game"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["ta_reading_game"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["ta_reading_game"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">TEAM PHILOSOPHY</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["team_philosophy"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["team_philosophy"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["team_philosophy"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["team_philosophy"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">ATTACKING PRINCIPLES</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["attacking_principles"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["attacking_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["attacking_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["attacking_principles"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">NEGATIVE TRANSITION PRINCIPLES</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["negative_transition_principles"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["negative_transition_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["negative_transition_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["negative_transition_principles"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">DEFENDING PRINCIPLES</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["defending_principles"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["defending_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["defending_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["defending_principles"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">POSITIVE TRANSITION PRINCIPLES </td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["positive_transition_principles"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["positive_transition_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["positive_transition_principles"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["positive_transition_principles"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">PLAYER POSITION & ROLE</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["player_position_role"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["player_position_role"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["player_position_role"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["player_position_role"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">SET-PIECE STRATEGIES</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[0]["set_piece_strategies"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[1]["set_piece_strategies"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr1]["set_piece_strategies"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$tactical_overview[$dynmic_arr2]["set_piece_strategies"].'</td>' : '';
            $html .='</tr>
...
$html .= '<section style="page-break-after:always">
    ...
    <table style="width: 100%;">
        <tbody>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">ASSESSMENT WITH THE BALL</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
            ...
            <tr>
                <td style=" padding: 20px 5px;">- SPEED 20m.</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["with_speed_20m"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["with_speed_20m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["with_speed_20m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["with_speed_20m"].'</td>' : '';
            $html .='</tr>

            <tr>
                <td style=" padding: 20px 5px;">- SPEED 40m.</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["with_speed_40m"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["with_speed_40m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["with_speed_40m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["with_speed_40m"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- ARROWHEAD AGILITY (LEFT SIDE)</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["with_arrowhead_agility_left_side"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["with_arrowhead_agility_left_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["with_arrowhead_agility_left_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["with_arrowhead_agility_left_side"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- ARROWHEAD AGILITY (RIGHT SIDE)</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["with_arrowhead_agility_right_side"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["with_arrowhead_agility_right_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["with_arrowhead_agility_right_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["with_arrowhead_agility_right_side"].'</td>' : '';
            $html .='</tr>

            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">ASSESSMENT WITHOUT THE BALL</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px;"></td>' : '';
            ...
            <tr>
                <td style=" padding: 20px 5px;">- SPEED 20m.</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["without_speed_20m"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["without_speed_20m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["without_speed_20m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["without_speed_20m"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- SPEED 40m.</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["without_speed_40m"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["without_speed_40m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["without_speed_40m"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["without_speed_40m"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- YO-YO INTERMITTENT RECOVERY TEST</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["yo_yo_intermittent_recovery_test"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["yo_yo_intermittent_recovery_test"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["yo_yo_intermittent_recovery_test"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["yo_yo_intermittent_recovery_test"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- ARROWHEAD AGILITY (LEFT SIDE)</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["without_arrowhead_agility_left_side"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["without_arrowhead_agility_left_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["without_arrowhead_agility_left_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["without_arrowhead_agility_left_side"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- ARROWHEAD AGILITY (RIGHT SIDE)</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["without_arrowhead_agility_right_side"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["without_arrowhead_agility_right_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["without_arrowhead_agility_right_side"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["without_arrowhead_agility_right_side"].'</td>' : '';
            $html .='</tr>
            <tr>
                <td style=" padding: 20px 5px;">- VERTICAL JUMP</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[0]["vertical_jump"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[1]["vertical_jump"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr1]["vertical_jump"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$physical_overview[$dynmic_arr2]["vertical_jump"].'</td>' : '';
            $html .='</tr>
        </tbody>
    </table>
    <p>*PLAYERS PERFORMANCE ON EACH MATRIC IS MEASURED IN SECONDS</p>
    </div>
</section>';
...
$html .= '<section style="page-break-after:always">
    ...
    <table style="width: 100%;">
     ...
     <p>*PLAYERS SCORED ON EACH ATTRIBUTE RATING FROM 1 TO 5.WITH 1 BEING THE LOWEST & 5 BEING THE HIGHEST</p>
     </div>
</section>';
...
$html .= '<section style="page-break-after:always">
    ...
    <table style="width: 100%;">
        <tbody>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">DEEP SQUAT</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["deep_squat"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["deep_squat"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["deep_squat"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["deep_squat"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">INLINE LUNGE </td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["inline_lunge"].'</td>': '';
                    $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["inline_lunge"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["inline_lunge"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["inline_lunge"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">HURDLE CROSSING </td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["hurdle_crossing"].'</td>': '';
                    $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["hurdle_crossing"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["hurdle_crossing"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["hurdle_crossing"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">ACTIVE SINGLE-LEG RAISE</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["active_single_leg_raise"].'</td>': '';
                    $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["active_single_leg_raise"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["active_single_leg_raise"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["active_single_leg_raise"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">TRUNK STABILITY PUSH-UPS</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["trunk_stability_push_ups"].'</td>': '';
                    $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["trunk_stability_push_ups"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["trunk_stability_push_ups"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["trunk_stability_push_ups"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">ROTATORY STABILITY </td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[0]["rotatory_stability"].'</td>': '';
                    $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[1]["rotatory_stability"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr1]["rotatory_stability"].'</td>' : '';
                    $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$functional_overview[$dynmic_arr2]["rotatory_stability"].'</td>' : '';
            $html .='</tr>

        </tbody>
    </table>
    <p>*PLAYERS SCORED ON EACH ATTRIBUTE RATING FROM 1 TO 3.WITH 1 BEING THE LOWEST & 3 BEING THE HIGHEST</p>
    </div>
</section>';
...
$html .= '<section style="page-break-after:always">
    ...
    <table style="width: 100%;">
        <tbody>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">EDUCATION</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_education"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_education"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_education"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_education"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">DISCIPLINE</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_discipline"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_discipline"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_discipline"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_discipline"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">HYGIENE</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_hygiene"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_hygiene"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_hygiene"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_hygiene"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">TEAMWORK</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_teamwork"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_teamwork"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_teamwork"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_teamwork"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">DIET</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_diet"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_diet"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_diet"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_diet"].'</td>' : '';
            $html .='</tr>
            ...
            <tr style="background-color: #ffc000;">
                <td style=" padding: 20px 5px;">CONDUCT</td>';
                $html .= ($report_type != 2) ? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[0]["notes_frm_resi_war_conduct"].'</td>': '';
                $html .= (($count_q == 2 || $count_q == 4) && $report_type != 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[1]["notes_frm_resi_war_conduct"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr1]["notes_frm_resi_war_conduct"].'</td>' : '';
                $html .= ($count_q == 4 || $report_type == 2)? '<td style="padding: 20px 5px; text-align: center;">'.$residence_notes_overview[$dynmic_arr2]["notes_frm_resi_war_conduct"].'</td>' : '';
            $html .='</tr>

        </tbody>
    </table>
    <h3>KEY OBSERVATIONS '.$default_q_name.'</h3>
    <p>'.$residence_notes_overview[0]["notes_frm_resi_war_key_observ"].'</p>';
    if($report_type == 3){
         $html .= '<h3>KEY OBSERVATIONS Cycle 2</h3>
        <p>'.$residence_notes_overview[1]["notes_frm_resi_war_key_observ"].'</p>';
    }
...
$mpdf->WriteHTML($html,2);
        ...
        $Mfiles = array();
         ...
         array_push($Mfiles,'./uploads/pdf/for_upload.pdf');
         array_push($Mfiles,'./uploads/pdf/for_upload.pdf');
