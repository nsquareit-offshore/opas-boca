                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="athlete_contact_no" class="form-control" id="athlete_contact_no" placeholder="Enter Contact No" pattern="[1-9]{1}[0-9]{9}" value="<?= $athlete_detail['contact_no']; ?>" required>
...
<!--                                     <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="athlete_team_program" class="form-control" id="athlete_team_program" required>
                                   ...
                                   <option value="Residential" <?= ($athlete_detail['team_program'] == 'Residential')? 'selected' : ''; ?>>Residential</option>
                                   <option value="Excellence" <?= ($athlete_detail['team_program'] == 'Excellence')? 'selected' : ''; ?>>Excellence</option>
                                   <option value="Academic" <?= ($athlete_detail['team_program'] == 'Academic')? 'selected' : ''; ?>>Academy</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="athlete_playing_position" class="form-control" id="athlete_playing_position" value="<?= $athlete_detail['playing_position']; ?>" placeholder="Enter Playing Position">
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="athlete_playing_position" class="form-control" id="athlete_playing_position" required>
                                   <option value="">Select Playing Position</option>
                                   <option value="Goalkeeper" <?= ($athlete_detail['playing_position'] == 'Goalkeeper')? 'selected' : ''; ?>>Goalkeeper</option>
                                   <option value="other" <?= ($athlete_detail['playing_position'] == 'other')? 'selected' : ''; ?>>other</option>
  ...
  <?php if($athlete_detail['team_program'] == 'Residential'){ ?>
  <script> 
     $("#athlete_team_name_sec select").html($("#athlete_resi_team_name").html());
  </script>
  <?php } ?>

   <?php if($athlete_detail['team_program'] == 'Excellence'){ ?>
  <script> 
     $("#athlete_team_name_sec select").html($("#athlete_exce_team_name").html());
  </script>
  <?php } ?>

   <?php if($athlete_detail['team_program'] == 'Academic'){ ?>
  <script> 
