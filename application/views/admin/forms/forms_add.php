                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" min="0" name="boday_com_hei_val" id="boday_height_val" placeholder="Enter Value" > 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" name="boday_com_weig_val" id="boday_weight_val" placeholder="Enter Value" > 
