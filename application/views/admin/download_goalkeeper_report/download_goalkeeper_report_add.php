              ...
              <tbody>
                ...
                if($admin_role_id == 6){
                    ...
                    foreach($all_athlete_qt as $data_athlete):
                        ...
                        $qtr = get_quarter_data_goalkeeper($data_athlete['id'],$_GET['year']);
      ...
      <div class="card card-default">
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open( base_url('admin/download_goalkeeper_report/report_pdf_download')); ?>
...
<script src="<?= base_url() ?>assets/plugins/datatables/dataTables.bootstrap4.js"></script><script src="https://gyrocode.github.io/jquery-datatables-checkboxes/1.2.12/js/dataTables.checkboxes.min.js"></script>
  ...
  <script>
    ...
    $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/download_goalkeeper_report/year_by_athlete",
        dataType: 'json',
...
$(document).on('change', '#select_year', function() {
    ...
    $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/download_goalkeeper_report/select_year",
        dataType: 'json',
...
$(document).on('change', '#key_performance_indicator', function() {
    var key_id = $('#key_performance_indicator').val();
    if(key_id.length >= 1){
        $('#btn_download').show();
    } else{
        $('#btn_download').hide();
...
$(document).ready(function() {  
 ...
 if(inc != 0 && inc >= 0){
   $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/dashboard/get_dash_send_email_goalkeeper",
