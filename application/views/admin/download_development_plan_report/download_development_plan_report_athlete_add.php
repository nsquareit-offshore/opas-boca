              ...
              <tbody>
                ...
                if($admin_role_id == 6){
                    ...
                    <tr>
                        ...
                        <td><?= $data_athlete['first_name']; ?> <?= $data_athlete['last_name']; ?></td>
                        <td>Yearly Report
                            <input type="hidden" name="qtr_name[<?= $data_athlete['id']; ?>]" id="qrt_sele_<?= $data_athlete['id']; ?>" value="<?= $qtr[0]['id']; ?>">
                        </td>
                    </tr>
                    <?php endforeach; ?>
    ...
    <section class="content">
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
              <h3 class="card-title"> <i class="fa fa-plus"></i>
              &nbsp; Download  Individual Development Plan Report </h3>
          </div>
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open( base_url('admin/download_development_plan_report/report_pdf_download')); ?>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="row">
                                <input type="hidden" name="select_athlete" id="select_athlete" value="<?php echo $this->session->userdata('athlete_id'); ?>">
                                <div class="col-md-4">
                                ...
                                <input type="hidden" name="key_performance_indicator" id="key_performance_indicator">
                               <!--  <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                            <div class="form-group">
                                <button type="button" class="btn btn-info" id="btn_view" style="display:none;"> View Report </button>
...
<script src="<?= base_url() ?>assets/plugins/datatables/dataTables.bootstrap4.js"></script><script src="https://gyrocode.github.io/jquery-datatables-checkboxes/1.2.12/js/dataTables.checkboxes.min.js"></script>
  ...
  <script>
    ...
    $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/download_development_plan_report/year_by_athlete",
        dataType: 'json',
...
$(document).on('change', '#select_year', function() {
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo base_url(); ?>admin/download_development_plan_report/select_year",
            dataType: 'json',
            data: "year_id="+year_id+'&athlete_id='+select_athlete,
            success:function(result){               
                $('#key_performance_indicator').val(result[0].id);
                $('#btn_download').show();
                $('#btn_view').show();
            }
        });
...
$(document).ready(function() {  
 ...
 if(inc != 0 && inc >= 0){
   $.ajax({
        type:'POST',
        url:"<?php echo base_url(); ?>admin/dashboard/get_dash_send_email_academic",
...
$(document).ready(function () {
    $('#btn_view').on('click', function () {
        ...
        var athlete_id = $('#select_athlete').val();
        ...
        $.ajax({
            url: "<?= base_url('admin/download_development_plan_report/report_view'); ?>",
            type: "POST",
            data: {
