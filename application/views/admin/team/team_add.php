      ...
      <div class="card card-default">
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open( base_url('admin/team/add')); ?>
            <div>
              <div>
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="team_name" class="form-control" id="team_name" value="" placeholder="Enter Team Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="team_location" class="form-control" id="team_location" value="" placeholder="Enter Location" required>
                            </div>
                        </div>
