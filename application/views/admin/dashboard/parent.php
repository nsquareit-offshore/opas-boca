  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0 text-dark">Welcome to Alchemy International Football Parent Dashboard</h1>
              <?php $user_array = (get_user_name_by_id($this->session->userdata('user_id')));         
              ?>
              <!-- <p class="m-0 text-dark"><?= "Your email : ".$user_array['email'] ?></p>  -->
