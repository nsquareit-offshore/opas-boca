<div class="form-background">
  <div class="login-box">
    <div class="login-logo">
      <img src="<?= base_url('assets/img/loginlogo.png');?>" alt="Logo" class="brand-image1 img-circle1 1elevation-3" style="opacity: 1;">
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <?php echo form_open(base_url('admin/auth/parentlogin'), 'class="login-form" '); ?>
